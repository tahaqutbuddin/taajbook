              ...
              <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                  ...
                  <input
                    ...
                    placeholder="Search By fullname,email,username"
                    aria-label="Search..."
                    id="search_box"
                    name="search_box"
                  />
                ...
                <!-- Basic Bootstrap Table -->
                  <div class="card">
                    <button type="button" class="btn btn-primary">
                      All Users
                      <span class="badge bg-white text-primary rounded-pill"><?php if(isset($allUsersCount)){echo $allUsersCount;}else{echo '0';} ?></span>
                    </button>
